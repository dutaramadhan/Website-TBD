...
import { Table } from "../CategoryPage/TableCategoryPage.jsx";
import { Modal } from "./ModalCategoryPage.jsx"; 
...
export function CategoryPage(){
  ...
  useEffect(()=>{
    const url = 'http://localhost:3100/api/v1/tbdprojectdatabase/categories'
    axios.get(url)
    .then(response =>{
